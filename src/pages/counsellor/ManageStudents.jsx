...
const ManageStudents = ({ setActivePage }) => {
  ...
  const handleDelete = async (id) => {
    if (await toast.confirm('Are you sure you want to delete this student? This action cannot be undone.', 'Delete Student')) {
      ...
      // Also remove any batch assignments for this student
      const assignments = JSON.parse(localStorage.getItem('studentBatchAssignments')) || [];
      const updatedAssignments = assignments.filter(a => a.studentId !== id);
