...
const Sidebar = () => {
  ...
  const currentUser = authUser || JSON.parse(localStorage.getItem('user')) || JSON.parse(localStorage.getItem('currentUser')) || {};
  const userName = currentUser.fullName || currentUser.username || 'Admin';
  const userEmail = currentUser.email || 'admin@worksphere.com';
