...
const CounsellorHome = ({ setActivePage }) => {
  ...
  const loadData = async () => {
    try {
      const [studentsRes, batchesRes, stAssignRes, trAssignRes, trainersRes] = await Promise.all([
      ...
      const studentBatchAssignments = stAssignRes.data || [];
      const batchTrainerAssignments = trAssignRes.data || [];
    ...
    setRecentStudents(students.slice(-5).reverse());
      ...
      console.error("Failed to load generic counsellor data", error);
    }
  };
